...
open class Cryptography(private val mContext: Context) {
    ...
    private fun initKeys() {
        ...
        if (!keyStore.containsAlias(KEY_ALIAS)) {
            ...
            } catch (e: NullPointerException) { // Bad to catch null pointer exception, but looks like Android 4.4.x
...
// https://issuetracker.google.com/issues/36983155
    ...
    fun encryptData(stringDataToEncrypt: String?): String {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            } catch (e: InvalidKeyException) { // Since the keys can become bad (perhaps because of lock screen change)
    ...
    companion object {
        ...
        private const val KEY_ALIAS = "S2lyYW4="
        ...
        private const val SHARED_PREFERENCE_NAME = "com.firebase.auth.demo.preference"
        private const val ENCRYPTED_KEY_NAME = "com.firebase.auth.demo.encrypt"
